...
},{"riot":"../../../node_modules/riot/riot.esm.js","bianco.query":"../../../node_modules/bianco.query/index.next.js"}],"../../../node_modules/color-name/index.js":[function(require,module,exports) {
'use strict'
...
},{"color-string":"../../../node_modules/color-string/index.js","color-convert":"../../../node_modules/color-convert/index.js"}],"components/video-view/video-panel.riot":[function(require,module,exports) {
"use strict";
...
function VideoPanel() {
  return {
    ...
    teamColorIsLight: function teamColorIsLight() {
      try {
        return (0, _color.default)(this.props.team.color).isLight();
      } catch (err) {
        return false;
      }
    },
    onMounted: function onMounted() {
      ...
      progressRep.on('change', function (newVal) {
        _this.state.progress = newVal[_this.props.idx];

        _this.update();
      });
      nodecg.listenFor('event:showSplit', function (data) {
        if (data.teamIdx !== _this.props.idx) {
          return;
        }

        _this.state.split.segment = data.segment;
        _this.state.split.time = data.time.split('.')[0];
        _this.state.exit = false;
        _this.state.showSplit = true;
        setTimeout(function () {
          _this.state.exit = true;
...
var _default = {
  ...
  'template': function template(_template, expressionTypes, bindingTypes, getComponent) {
    return _template('<div expr35="expr35" class="border-tr"></div><div expr36="expr36" class="border-bl"></div><div expr37="expr37"><div expr38="expr38" class="columns is-marginless label-content"></div></div><div expr45="expr45"></div>', [{
      ...
      'expressions': [{
        ...
        'evaluate': function evaluate(scope) {
          return ['border-color: ', scope.props.team.color].join('');
        }
      }]
    }, {
      ...
      'expressions': [{
        ...
        'name': 'class',
        'evaluate': function evaluate(scope) {
          return ['label-container ', scope.props.idx < 2 ? 'is-bottom' : 'is-top', ' ', scope.teamColorIsLight() ? 'has-text-dark' : 'has-text-light'].join('');
        }
      }, {
        'type': expressionTypes.ATTRIBUTE,
        'name': 'style',
        'evaluate': function evaluate(scope) {
          return ['background-color: ', scope.props.team.color, ';'].join('');
        }
      }]
    }, {
      'type': bindingTypes.IF,
      'evaluate': function evaluate(scope) {
        return scope.state.progress.segments.current;
      },
      'redundantAttribute': 'expr38',
      'selector': '[expr38]',
      'template': _template('<div expr39="expr39" class="column is-paddingless has-text-centered"> <span expr40="expr40" class="icon" style="margin-left:0.5rem;"></span><span expr41="expr41" style="position: absolute; bottom: 0%; margin-left: 0.5rem;"><span expr42="expr42"></span><span expr43="expr43"></span><span expr44="expr44"></span></span></div>', [{
      ...
      'template': _template(' ', [{
        'expressions': [{
          ...
          'childNodeIndex': 0,
          'evaluate': function evaluate(scope) {
            return ['\r\n        ', scope.state.split.segment, ' - ', scope.state.split.time, '\r\n    '].join('');
          }
        }, {
          'type': expressionTypes.ATTRIBUTE,
          'name': 'class',
          'evaluate': function evaluate(scope) {
            return ['notification is-info is-light split animated ', scope.props.idx < 2 ? 'is-bottom' : 'is-top', ' ', scope.state.exit ? 'fadeOut' : 'fadeIn'].join('');
          }
        }]
      }])
    }]);
...
},{"color":"../../../node_modules/color/index.js"}],"components/video-view/video-view.riot":[function(require,module,exports) {
"use strict";
...
var _videoPanel = _interopRequireDefault(require("./video-panel.riot"));
  ...
  return {
    ...
    onMounted: function onMounted() {
      ...
      teamListRep.on('change', function (newVal) {
        _this.state.teamList = newVal;

        _this.update();
      });
      graphicsRep.on('change', function (newVal) {
        _this.state.soundEnableIndex = newVal.soundEnableIndex;
...
VideoView.components = {
  VideoPanel: _videoPanel.default
};
var _default = {
  ...
  'exports': VideoView,
  'template': function template(_template, expressionTypes, bindingTypes, getComponent) {
    return _template('<div class="columns is-marginless is-multiline panel-container"><video-panel expr5="expr5" class="column is-paddingless is-half top"></video-panel></div>', [{
      ...
      'template': _template(null, [{
        ...
        'attributes': [{
          ...
          'evaluate': function evaluate() {
            return 'column is-paddingless is-half top';
          }
        }, {
          'type': expressionTypes.ATTRIBUTE,
          'name': 'idx',
...
exports.default = _default;
},{"./video-panel.riot":"components/video-view/video-panel.riot"}],"video.ts":[function(require,module,exports) {
"use strict";
...
var _videoView = _interopRequireDefault(require("./components/video-view/video-view.riot"));
...
riot.component(_videoView.default)(document.getElementById("root") || document.body, {});
},{"@riotjs/hot-reload":"../../../node_modules/@riotjs/hot-reload/index.js","riot":"../../../node_modules/riot/riot.esm.js","./components/video-view/video-view.riot":"components/video-view/video-view.riot"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","video.ts"], null)
//# sourceMappingURL=video.54a03772.js.map