...
},{"riot":"../../../node_modules/riot/riot.esm.js","bianco.query":"../../../node_modules/bianco.query/index.next.js"}],"components/checkpoint/segment.riot":[function(require,module,exports) {
"use strict";
...
function Segment() {
  return {
    ...
    calcTopTeam: function calcTopTeam(currentSegs) {
      var topIndex = -1;
      var topSegment = {
        run: -1,
        seg: -1
      ...
      for (var i = 0; i < currentSegs.length; i++) {
        ...
        } else if (currentSegs[i].runIndex === topSegment.run && currentSegs[i].segIndex > topSegment.seg) {
          topIndex = i;
          topSegment.run = currentSegs[i].runIndex;
          topSegment.seg = currentSegs[i].segIndex;
        }
...
var _default = {
  ...
  'template': function template(_template, expressionTypes, bindingTypes, getComponent) {
    return _template('<div class="columns is-vcentered is-marginless is-mobile is-multiline top"><div expr16="expr16"></div><div expr21="expr21" class="column is-full has-background-dark has-text-white"> </div></div>', [{
      'type': bindingTypes.EACH,
      'getKey': null,
      'condition': null,
      'template': _template('<figure expr17="expr17" class="image is-48x48 flag"></figure><figure expr19="expr19" class="image flag"></figure>', [{
        'expressions': [{
          'type': expressionTypes.ATTRIBUTE,
          'name': 'class',
          'evaluate': function evaluate(scope) {
            return ['column is-paddingless has-text-centered has-text-info ', scope.current != null && scope.current.runIndex < scope.props.runIdx ? 'no-reached' : '', ' ', scope.current != null && scope.current.runIndex == scope.props.runIdx && scope.current.segIndex <= scope.props.segIdx ? 'no-reached' : '', ' ', scope.idx < scope.state.currentSegments.length - 1 ? 'not-last-segment' : ''].join('');
          }
        }]
      }, {
        ...
        'selector': '[expr17]',
        'template': _template('<img expr18="expr18"/>', [{
          'type': bindingTypes.IF,
          'evaluate': function evaluate(scope) {
        ...
        'selector': '[expr19]',
        'template': _template('<span class="icon"><i expr20="expr20" class="fas fa-flag"></i></span>', [{
          'type': bindingTypes.IF,
          'evaluate': function evaluate(scope) {
            return scope.current != null && scope.current.runIndex == scope.props.runIdx && scope.current.segIndex == scope.props.segIdx;
          },
...
},{"color-string":"../../../node_modules/color-string/index.js","color-convert":"../../../node_modules/color-convert/index.js"}],"components/checkpoint/checkpoint.riot":[function(require,module,exports) {
"use strict";
...
var _segment = _interopRequireDefault(require("./segment.riot"));
...
function Checkpoint() {
  return {
    ...
    teamColorIsLight: function teamColorIsLight(team) {
      return (0, _color.default)(team.color).isLight();
    },
    onMounted: function onMounted() {
      var _this = this;
    ...
    calcCheckpointIndex: function calcCheckpointIndex() {
...
var _default = {
  ...
  'exports': Checkpoint,
  'template': function template(_template, expressionTypes, bindingTypes, getComponent) {
    return _template('<div class="container"><section class="hero has-background-light"><div class="hero-body"><div class="container"><h1 class="title is-5">\r\n                        チェックポイント\r\n                    </h1></div></div></section><div class="columns is-marginless is-mobile has-text-white has-background-dark"><div expr5="expr5"></div></div><div expr6="expr6"></div></div>', [{
      'type': bindingTypes.EACH,
      'getKey': null,
      'condition': null,
      'template': _template(' ', [{
        'expressions': [{
          ...
          'name': 'class',
          'evaluate': function evaluate(scope) {
            return ['column has-text-centered ', scope.idx < scope.state.teams.length - 1 ? 'not-last-segment' : '', ' ', scope.teamColorIsLight(scope.team) ? 'has-text-dark' : 'has-text-light'].join('');
          }
        }, {
          'type': expressionTypes.ATTRIBUTE,
          'name': 'style',
      ...
      'getKey': null,
      'condition': null,
      'template': _template('<div expr7="expr7"></div><segment expr9="expr9"></segment>', [{
        'type': bindingTypes.IF,
        'evaluate': function evaluate(scope) {
        ...
        'selector': '[expr7]',
        'template': _template('<div class="column has-text-centered"><div expr8="expr8"> </div></div>', [{
          'expressions': [{
            'type': expressionTypes.ATTRIBUTE,
            'name': 'class',
            'evaluate': function evaluate(scope) {
              return ['columns is-marginless is-mobile has-text-white has-text-weight-bold ', scope.run.image ? 'game-imaged' : 'has-background-primary'].join('');
            }
          }, {
            'type': expressionTypes.ATTRIBUTE,
            'name': 'style',
        ...
        'type': bindingTypes.EACH,
        'getKey': null,
        'condition': function condition(scope) {
...
exports.default = _default;
},{"./segment.riot":"components/checkpoint/segment.riot","color":"../../../node_modules/color/index.js"}],"checkpoint.ts":[function(require,module,exports) {
"use strict";
...
var _checkpoint = _interopRequireDefault(require("./components/checkpoint/checkpoint.riot"));
...
riot.component(_checkpoint.default)(document.getElementById("root") || document.body, {});
},{"@riotjs/hot-reload":"../../../node_modules/@riotjs/hot-reload/index.js","riot":"../../../node_modules/riot/riot.esm.js","./components/checkpoint/checkpoint.riot":"components/checkpoint/checkpoint.riot"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","checkpoint.ts"], null)
//# sourceMappingURL=checkpoint.846431ef.js.map